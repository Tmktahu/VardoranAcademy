# Field Alchemy: Enchanted Enhancement Basics
...
"We're not all blade-swingers," she said. "Magical support requires its own enhancements. This makes spells hit harder."

I expected different plants, complex preparation, maybe theoretical discussion of magical resonance. Instead: snow flower, fish bone, water. Same basic method as their physical enhancement brew, just different plant source.
...
Support casters report that healing and protective spells benefit equally. Enhanced spell power applies to all magical workings, not just offensive applications.
...
She's right, though admitting that bothers me.
## Field Modifications
Hunters have shared several practical variations:

For extended operations, they prepare double batches in two waterskins. One for immediate use, one as backup. The brew maintains potency for about three days when properly sealed.

Some hunters mix this with warming teas to offset snow flower's cooling effect. Doesn't impact magical enhancement but makes consumption more comfortable in cold weather.

Dried snow flower works acceptably when fresh unavailable, though hunters report noticeably reduced effectiveness. They adjust by using more dried flowers or accepting weaker enhancement.
## Important Warnings
Don't assume enhanced spell power automatically means better results. You still need proper technique and control. Stronger spells poorly executed just fail more spectacularly.

Store away from extreme cold despite snow flower's frost affinity. Frozen brew doesn't pour properly. Keep it cold, not frozen.

Fresh preparation works better than stored brew. The fish bone compounds begin degrading after a few days in aqueous solution. Mix it shortly before expected use for optimal results.