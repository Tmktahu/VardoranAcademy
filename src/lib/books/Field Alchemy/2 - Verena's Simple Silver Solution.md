...
"You're using fire blossom for fire resistance," she pointed out. "What happens if you just use snow flower for silver resistance?"
...
Merchants handling silver currency appreciate this brew. Prolonged exposure to silver coins causes discomfort in vampiric handlers; the resistance allows normal business transactions without protective gloves.

Some vampires use it preemptively when traveling through human territories where silver weapons are common. Better to maintain protection than scramble for it during confrontation.

Interestingly, several Academy researchers working with silver-based magical implements report this brew as essential equipment. Apparently silver makes excellent arcane conductor, but only if you can handle it safely.
## What I Learned From Failure
Before Verena's suggestion, I tried seventeen different approaches:

**Attempt #7:** Combined snow flower with iron filings. Theory: iron blocks silver's magical properties. Reality: created gritty, useless sludge that accomplished nothing.

**Attempt #11:** Distilled snow flower essence with gemstone dust. Expensive, time-consuming, completely ineffective. The gemstone just made it sparkle, which was pretty but unhelpful.
...
Don't heat the mixture. I thought warming it might extract compounds more efficiently. Instead, it destroys the frost affinity entirely and produces completely inert liquid. Use room temperature water only.
