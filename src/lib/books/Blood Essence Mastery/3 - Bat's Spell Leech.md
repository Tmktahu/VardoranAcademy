# Blood Essence Mastery: Bat's Spell Leech
...
**Preparation:**
Grind blood rose and bleeding heart separately. Keep apart until essence addition. Blood rose's healing properties and bleeding heart's draining properties can conflict if combined prematurely.

Dissolve Greater Blood Essence in minimal water using gentle heat and patience. Once fully dissolved, add ground blood rose first. Stir until deep red suspension forms. Then add bleeding heart gradually. The color shifts to dark crimson as both plants integrate.

Continue stirring five minutes for stabilization. The healing and draining properties need time to settle into balanced configuration within essence matrix. Transfer to glass bottle immediately and seal quickly.

**Effect:**
One bottle provides 24 hours enhanced spell leech and cooldown recovery. Spells drain approximately 5% more life from targets, and spell ability cooldowns recover 7% faster. This makes sustained magical combat significantly more viable.
## Practical Uses
Combat mages relying on life-draining spells benefit enormously. The enhanced leech allows sustained engagement without external healing support.

Magical duelists appreciate cooldown reduction enabling more aggressive spell usage. More frequent access to key spells provides tactical advantages in extended magical combat.
...
This is third elixir I developed, working systematically through combat applications. Weapon life leech (Crow), spell life leech (Bat), then I branched into other combat effects. Total: eight functional formulations from hundreds of tested combinations."
## Comparison with Elixir of the Crow
Students often ask about differences between these elixirs:

**Target Users:** Crow serves weapon-focused combatants. Bat serves spellcasters. Each optimizes for its user type.

**Enhancement Type:** Crow affects weapon damage and weapon ability cooldowns. Bat affects spell damage and spell ability cooldowns. The enhancements don't overlap.

**Plant Selection:** Crow uses death-magic-based and vampiric plants. Bat uses healing-based and vampiric plants. Different property combinations for same general effect pattern.
...
Cooldown reduction affects spell abilities specifically, not weapon abilities. If you use mixed combat style, only magical cooldowns improve.

Greater Blood Essence remains expensive and difficult to obtain. Don't waste it on practice attempts. Understand process completely before preparation.

The dark crimson color is correct. Lighter red means insufficient bleeding heart. Brownish red means overheated essence. Either indicates failure requiring restart.