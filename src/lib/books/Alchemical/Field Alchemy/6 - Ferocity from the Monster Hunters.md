# Field Alchemy: Ferocity from the Monster Hunters
...
"How do you survive?" I asked. "Monster hunting is notoriously lethal."

She pulled out a waterskin. "We drink this before every hunt. Makes us hit harder. Gives us edge we need."
...
## The Formula
**Ingredients:**
- 32 measures hell's clarion (fresh or dried works equally)
- 1 fish bone (any fish species)
- 1 empty waterskin
...
Military forces have adopted the formula for shock troops and frontline combatants. Any situation requiring maximum physical impact benefits from enhanced strength.

Arena fighters use it frequently, though some competitions ban it as unfair advantage. Mira's response: "Combat isn't fair. Preparing properly isn't cheating."

The brew also sees use in non-combat applications requiring physical strength: heavy construction, emergency debris removal, situations where brute force solves problems.
...
I've attempted to determine the actual mechanism. Hell's clarion's chaos properties clearly provide the strength enhancement. The fish bone's role remains unclear beyond "it makes the brew less likely to turn you into raging idiot." Sometimes that's sufficient explanation.
## Important Warnings
The heightened aggression is real. Mira warns against drinking this during tense negotiations or anywhere you need diplomatic restraint. The brew makes violence feel like better solution than it actually is.

Don't use this for marathon physical labor. The enhancement works well for extended activities but isn't meant for days of continuous exertion. The enhanced strength comes with enhanced exhaustion afterward.

Hell's clarion from different regions varies in potency. Ashen Keep hunters use Dunley cavern mushrooms exclusively. If sourcing from elsewhere, you may need to adjust quantities through testing.

Fresh preparation works better than stored brew. Mix it the night before use, not days in advance. The fish bone compounds degrade in aqueous solution, reducing stabilizing effects over time.