...
The formula required careful balancing. Too much sacred grape and the holy essence becomes problematic for vampiric casters. Too little and you're just making expensive Enchanted Brew. The 60:60 ratio proved optimal through extensive testing with Academy's combat magic instructors.
## The Formula
**Ingredients:**
- 60 measures sacred grapes (must be from Brighthaven)
- 60 measures snow flower
- 1 fish bone
...
Academy battle mages consider it standard equipment for serious engagements. The enhanced power allows spells that would normally require multiple casters to be executed by single properly-prepared mage.

Ritual magic practitioners report this potion enables workings that would otherwise exceed single caster's capacity. The amplification brings previously-impossible magical operations within reach.
...
**Attempt #18:** Added blood essence thinking vampiric component might balance holy properties better than fish bone. Created mixture that separated immediately and accomplished nothing. Stick with fish bone.

The 60:60:1 ratio represents optimal balance between power, stability, and tolerability for all caster types.
## Comparison with Basic Brew
Students regularly ask whether Witch Potion replaces Enchanted Brew. The answer depends on circumstances:

**Cost:** Sacred grapes from Brighthaven are expensive and supply-limited. Basic brew uses only snow flower, which is readily available and affordable.

**Tolerance:** Vampiric casters find the holy trace uncomfortable. Some prefer basic brew's complete absence of holy properties despite reduced power.

**Complexity:** This requires precise preparation with glass bottles and extended steeping. Basic brew works with simpler equipment and faster preparation.

Use basic brew for routine magical enhancement. Save this for situations where maximum spell power justifies the cost and preparation effort.
## Important Warnings
Vampiric casters will feel slight discomfort from holy essence. This doesn't prevent spellcasting but can be distracting. Test your tolerance with small doses before relying on full bottles during combat.

Don't combine with Enchanted Brew expecting additive effects. The mechanisms overlap; only the stronger effect manifests. You'll just waste materials.

Sacred grapes must be from Brighthaven. I've tested grapes from other sources. They produce brew that looks similar but provides minimal magical enhancement. The consecrated soil's influence is essential.

Store sealed in glass bottles away from extreme temperatures. The sacred grape/snow flower combination remains chemically active. Improperly stored batches lose potency rapidly.

If you experience unusually intense magical sensitivity lasting beyond two hours, discontinue use. That indicates either improper preparation or unexpected interaction with your personal magical resonance.